...
class UrlPolicy:
    """Apply HTTP(S) and same-origin checks to one caller or browser URL."""

    def __init__(self, url: str, allow_plain_http: bool):
        self.url = url
    ...
    def validate_observed_url(self, allowed_origin: Origin) -> None:
